...
global.mods = []
global.prems = []
global.nomorbot = '60149507978'
global.nameown = 'XienModz'
...
global.author = 'XienModz' //ganti aja cuyyy
global.namebot = '​Xien-Md' //nama bot luh
global.wm = '© Xien-Md' //ganti aja
global.media = 'https://telegra.ph/file/ab68380bb0aa70a2996af.jpg' //bebas
global.wm = 'Xien-Md ' //wm nyaa kocak
global.watermark = wm //bebas
global.wm2 = 'YenzModz' //ganti ajaa 
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`//ga usah dehhh 
global.bottime = `T I M E : ${wktuwib}` //ini juga ga usah 
global.titlebot = `Xien-Md | XienModz` //gantu aja
global.stickpack = 'Xien-Modz' //ganti 
global.stickauth = `© Xien-Md` //gantii 
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'Syenzky Yenxiu' //ganti 
global.nameown2 = 'XienModz' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.Linkgc = 'Tunggu Sebentar Kak...'
global.lynk = 'https://chat.whatsapp.com/JqRjltjSdv7FoDyi5ukoCq'//ganti jadi link gc luh


//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA SOSSIAL ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = 'https://instagram.com/syenzky' //ganti jadi ig mu
global.sgh = 'https://github.com/Syenzkyy' //github
global.sgc = 'https://chat.whatsapp.com/JqRjltjSdv7FoDyi5ukoCq' //group whatsapp
